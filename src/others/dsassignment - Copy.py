...
def standardrize_columns(tdf,revcol_mapping):
    ...
    for col in tdf.columns:
        ...
        if clean_col in revcol_mapping and clean_col not in new_columns:
            new_columns.append(revcol_mapping[clean_col])
        else:
            new_columns.append(clean_col.replace('_', ''))  # keep as is
